...
This means for the `2w*2w` design above there are 80 participants/subjects with a total of 320 observations.
...
3. plot: Set to FALSE to not print the plot (default = FALSE)

...
- liberal_lambda argument added: allows users to specify the type of lambda calcuations
...
- plot_power now has reduced sample size limitations
  -Option to use ANOVA_exact2 (exact2 argument) improves functionality (not limited to product of factors)
